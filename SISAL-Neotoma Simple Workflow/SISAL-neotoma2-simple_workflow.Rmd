...
```{r setup, echo=FALSE}
options(warn = -1)
pacman::p_load(neotoma2, dplyr, ggplot2, sf, geojsonsf, leaflet, flextable, readr, stringr, rioja, tidyr, patchwork)
```
...
pacman::p_load(neotoma2, dplyr, ggplot2, sf, geojsonsf, leaflet, terra, flextable, readr, stringr, rioja) 
```
