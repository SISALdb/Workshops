...
```{r setup, echo=FALSE}
options(warn = -1)
pacman::p_load(neotoma2, dplyr, ggplot2, sf, geojsonsf, leaflet, DT, readr, stringr, rioja, tidyr, patchwork)
```
...
```{r plotIsotopes, message=FALSE, warning=FALSE, out.width='90%'}
